  ...
  return (
    <div className="min-h-screen bg-[#0d1117] text-[#c9d1d9] font-sans selection:bg-[#58a6ff]/30 flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 overflow-y-auto pb-10 pt-10">
        ...
        >
          <div className="w-20 h-20 bg-[#161b22] border border-[#30363d] shadow-lg shadow-[#0d1117] rounded-xl flex items-center justify-center mx-auto mb-6">
            <GitBranch className="w-10 h-10 text-[#c9d1d9]" />
          </div>
          <h2 className="text-4xl md:text-5xl font-bold mb-4 text-[#c9d1d9] tracking-tight">Verify what your codebase actually does.</h2>
          <p className="text-lg text-[#8b949e] font-mono max-w-2xl mx-auto">
        ...
        <motion.div 
          ...
          className="w-full max-w-2xl bg-[#161b22] border border-[#30363d] p-8 rounded-lg shadow-sm"
        >
          <form onSubmit={handleAnalyze} className="flex flex-col gap-4">
            ...
            <div className="relative group">
              ...
              <input
                type="url"
                className="block w-full pl-12 pr-4 py-4 bg-[#0d1117] border border-[#30363d] rounded-md focus:ring-1 focus:ring-[#58a6ff] focus:border-[#58a6ff] text-[#c9d1d9] placeholder-[#8b949e] font-mono text-sm shadow-inner outline-none transition-shadow"
            ...
            <div className="mt-2">
              ...
              <div className="flex items-center gap-2 bg-[#0d1117] border border-[#30363d] p-1 rounded-md w-fit shadow-inner">
            ...
            <div className="flex justify-between items-center mt-4">
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="px-6 py-3 rounded-md font-bold font-sans text-[#c9d1d9] bg-[#21262d] hover:bg-[#30363d] border border-[#30363d] shadow-sm transition-colors flex items-center"
                >
                  Try a Demo
                </button>
                <button
                  type="submit"
                  className="px-6 py-3 rounded-md font-bold font-sans text-white bg-[#238636] hover:bg-[#2ea043] border border-[rgba(240,246,252,0.1)] shadow-sm transition-colors flex items-center"
                >
                  Run Analysis
                </button>
              </div>
        ...
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="w-full max-w-5xl mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-[#161b22] border border-[#30363d] p-6 rounded-lg text-center shadow-sm">
              <div className="text-3xl font-black text-[#58a6ff] mb-2 font-mono">100%</div>
              <div className="text-sm font-bold text-[#c9d1d9] mb-2">AST-Grounded Claims</div>
              <div className="text-[11px] text-[#8b949e] font-mono">Zero hallucinated architecture maps. Every insight is verified against the dependency graph.</div>
            </div>
            <div className="bg-[#161b22] border border-[#30363d] p-6 rounded-lg text-center shadow-sm">
              <div className="text-3xl font-black text-[#3fb950] mb-2 font-mono">&lt; 2s</div>
              <div className="text-sm font-bold text-[#c9d1d9] mb-2">Cached Re-Analysis</div>
              <div className="text-[11px] text-[#8b949e] font-mono">SHA-keyed disk cache returns previous results in milliseconds. First-run analysis takes 60–120s.</div>
            </div>
            <div className="bg-[#161b22] border border-[#30363d] p-6 rounded-lg text-center shadow-sm">
              <div className="text-3xl font-black text-[#a371f7] mb-2 font-mono">Instant</div>
              <div className="text-sm font-bold text-[#c9d1d9] mb-2">SHA-Based Caching</div>
              <div className="text-[11px] text-[#8b949e] font-mono">Results are cached securely by commit hash. Re-analyzing the same code is instantaneous.</div>
            </div>
          </div>
        </motion.div>
        
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.5 }} className="mt-12 text-center text-xs font-mono text-[#8b949e] border-t border-[#30363d] pt-8 w-full max-w-2xl">
